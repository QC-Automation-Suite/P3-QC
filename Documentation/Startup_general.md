...
3. Add the 4 Processes into an appropriate Folder-structure.
...
The execution of each of these 3 automations (_P0 Analyzer_, _QC Report Helper_, _QC Scheduler_) is mapped to a _Button_ element. Clicking a button results in the execution of the corresponding automation via UiPath Assistant (in tandem with Orchestrator). The status of the execution is displayed at the bottom of the page.
